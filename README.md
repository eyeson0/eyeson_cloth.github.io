...
Premium luxury fashion e-commerce website. Pure HTML5 / CSS3 / Vanilla JS — no build step, no frameworks.
...
json/  products / collections / categories / reviews / users (data mirrors for a future backend)
